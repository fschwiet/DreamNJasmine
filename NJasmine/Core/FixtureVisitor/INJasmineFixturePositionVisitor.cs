...
namespace NJasmine.Core.FixtureVisitor
{
    public interface INJasmineFixturePositionVisitor
    {
        ...
        TArranged visitArrange<TArranged>(TestPosition position) where TArranged : class, IDisposable, new();
        TArranged visitArrange<TArranged>(Func<TArranged> factory, TestPosition position) where TArranged : class, IDisposable;
    }
}
